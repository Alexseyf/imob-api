...
router.get("/", verificaToken_1.verificaToken, verificaSuporte_1.verificaSuporte, async (req, res) => {
    try {
...
router.post("/", verificaToken_1.verificaToken, verificaSuporte_1.verificaSuporte, async (req, res) => {
